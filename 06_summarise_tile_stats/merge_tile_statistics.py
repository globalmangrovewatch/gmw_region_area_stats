...
for year in ['1996', '2007', '2008', '2009', '2010', '2015', '2016', '2017', '2018', '2019', '2020']:
    merge_gmw_tile_stats(tile_stats_dir=f'/home/pete/Documents/gmw_v3_regional_stats/data/stats/country_stats/tile_stats/gmw_{year}_v3',
                         out_json_file=os.path.join(out_dir, f"gmw_v3_{year}_gmw_fid_uid_stats.json"),
                         uid_lut_file="../02_define_unique_code/un_boundaries_fid_lut.json",
                         out_feather=os.path.join(out_dir, f"gmw_v3_{year}_gmw_fid_uid_stats.feather"),
                         out_excel=os.path.join(out_dir, f"gmw_v3_{year}_gmw_fid_uid_stats.xlsx"),
                         excel_sheet=f"gmw_v3_{year}",
                         out_csv=os.path.join(out_dir, f"gmw_v3_{year}_gmw_fid_uid_stats.csv"),)
